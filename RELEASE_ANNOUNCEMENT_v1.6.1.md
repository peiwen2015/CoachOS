# CoachOS v1.6.1 Release Announcement

## 繁體中文

CoachOS v1.6.1 已發布。

這次更新讓 Activity Comparison 交給 AI 的資料更接近教練實際判讀所需的上下文。除了配速、心率、功率、步態與訓練負荷，現在也會帶入可用的氣溫、濕度、風、天氣、鞋款、RPE、主觀感受、Stamina、爬升與下降資訊，協助 AI 區分訓練表現差異與環境或課程背景差異。
